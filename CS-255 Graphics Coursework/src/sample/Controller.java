...
public class Controller {
	...
	public void doGraphs() {
		...
		// Red Chart
		final AreaChart<Number, Number> redChart =
				new AreaChart<Number, Number>(redXAxis,
						redYAxis);
		...
		// Green Chart
		final AreaChart<Number, Number> greenChart =
				new AreaChart<Number, Number>(greenXAxis,
						greenYAxis);
		...
		// Blue Chart
		final AreaChart<Number, Number> blueChart =
				new AreaChart<Number, Number>(blueXAxis,
						blueAxis);
		...
		// Brightness Chart
		final AreaChart<Number, Number> brightChart =
				new AreaChart<Number, Number>(brightXAxis,
						brightAxis);
